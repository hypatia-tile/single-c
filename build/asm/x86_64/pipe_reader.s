...
## %bb.0:
	...
	movl	$0, -36(%rbp)
Ltmp0:
	.loc	0 7 34 prologue_end             ## src/pipe_reader.c:7:34
	leaq	-32(%rbp), %rsi
	.loc	0 7 15 is_stmt 0                ## src/pipe_reader.c:7:15
	xorl	%edi, %edi
	movl	$16, %edx
	callq	_read
	.loc	0 7 11                          ## src/pipe_reader.c:7:11
	movq	%rax, -48(%rbp)
Ltmp1:
	.loc	0 9 9 is_stmt 1                 ## src/pipe_reader.c:9:9
	cmpq	$0, -48(%rbp)
	jge	LBB0_3
## %bb.1:
Ltmp2:
	.loc	0 10 5                          ## src/pipe_reader.c:10:5
	leaq	L_.str(%rip), %rdi
	callq	_perror
...
Ltmp5:
	.loc	0 15 23 is_stmt 0               ## src/pipe_reader.c:15:23
	movq	-56(%rbp), %rax
	.loc	0 15 25                         ## src/pipe_reader.c:15:25
	cmpq	-48(%rbp), %rax
Ltmp6:
...
## %bb.6:                               ##   in Loop: Header=BB0_4 Depth=1
	.loc	0 15 31 is_stmt 1               ## src/pipe_reader.c:15:31
	movq	-56(%rbp), %rax
	addq	$1, %rax
	movq	%rax, -56(%rbp)
